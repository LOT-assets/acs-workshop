...
* Create a file named co-ns.yaml with the follow content:
...
* Create a Namespace object running:
...
* Create a file named co-og.yaml with the follow content:
...
* Create the Compliance Operator OperatorGroup object running:
...
* Create a file named co-subs.yaml with the follow content:
...
* Create the Compliance Operator Subscription object running:
...
* Create a file named co-scan.yaml with the follow content:
